words = [
    ...
    "agreement", "ahead", "air", "all", "alert", "allow", "almost", "alone", "along", "already", 
    ...
    "bar", "base", "be", "beat", "beautiful", "because", "become", "bed", "before", 
    ...
    "drug", "during", "each", "early", "east", "easy", "eat", "economic", "economy", 
    ...
    "how", "however", "huge", "human", "hundred", "husband", "I", "idea", "identify", 
    "if", "image", "imagine", "impact", "important", "improve", "in", "include", 
    ...
    "love", "low", "machine", "magazine", "main", "maintain", "major", "majority", "make", 
    ...
    "network", "never", "new", "news", "newspaper", "next", "nice", "night", "no", 
